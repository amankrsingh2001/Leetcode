          ...
          "create": [
            {
              ...
              "output": "[1,1,2,3,4,4]",
              "explanation": "By comparing nodes one by one, we splice them together in ascending order: 1 from list1, 1 from list2, 2 from list1, and so on."
            }
          ]
        }
      }
          ...
          "create": [
            {
              ...
              "output": "[[-1,-1,2],[-1,0,1]]",
              "explanation": "nums[0] + nums[1] + nums[2] = (-1) + 0 + 1 = 0. nums[1] + nums[2] + nums[4] = 0 + 1 + (-1) = 0. The distinct triplets that sum up to 0 are returned without duplicates."
            }
          ]
        }
      }
          ...
          "create": [
            {
              ...
              "output": "49",
              "explanation": "The max water is trapped between the vertical line at index 1 (height 8) and index 8 (height 7). The width is 8 - 1 = 7, and the effective height is min(8, 7) = 7. Total area = 7 * 7 = 49."
            }
          ]
        }
      }
          ...
          "create": [
            {
              ...
              "output": "[[-2,2]]",
              "explanation": "The distance from (1, 3) to origin is sqrt(10). The distance from (-2, 2) to origin is sqrt(8). Since sqrt(8) < sqrt(10), (-2, 2) is closer, and we need k=1 closest point."
            }
          ]
        }
      }
